...
function Post({ id, username, userImg, img, caption }) {
    ...
    return (
        <div className="bg-white my-7 border rounded-sm">
            {/*Header */}
            <div className = "flex items-center p-5"> {/*Parent div container; tailwind css helps remove the need for styled sheets and styled compnents;  */}
                <img 
                    src ={userImg} 
            ...
            {session && (
                <form className="flex items-center p-4">
                    ...
                    <input
                        ...
                        className="border-non flex-1 focus:ring-0 outline-none"
                    />
                    <button 
                        type="submit" 
