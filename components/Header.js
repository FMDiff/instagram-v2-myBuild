        ...
        <div className="shadow-sm border-b bg-white sticky top-0 z-50">
            <div className="flex items-center justify-between max-w-6xl mx-5 lg:mx-auto">
             {/* Left*/}
                ...
                {/* Middle*/}
                <div className = "max-w-xs"> {/* main container for the entire search bar */}
                    <div className="relative mt-1 p-3 rounded-md"> {/* Subcontainer for the search bar to link searchicon with input field */}
                        <div className="absolute inset-y-0 pl-3 flex items-center pointer-events-none"> {/*Container for just the search icon */}
                ...
                {session ? (
                    <>
                        <div className = "relative navBtn">
                            ...
                            h-5 bg-red-500 rounded-full flex items-center
